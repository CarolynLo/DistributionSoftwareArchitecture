		...
		while (true)
		{
			try
			{
				...
				****************************************************************************/
				...
				if(id == 4){
					results+=formatter.format( Double.longBitsToDouble(measurement))+"\n";
//					System.out.println(results);
//					results="";
				}else if(id != 0){
					results+=formatter.format( Double.longBitsToDouble(measurement))+", ";
				}else{
					results+=TimeStampFormat.format(TimeStamp.getTime())+", ";
				}
//				if ( id!=0)
//				{
//					System.out.println(formatter.format(4.0));
//					System.out.print( TimeStampFormat.format(TimeStamp.getTime()) + " ID = " + id + " " + formatter.format(Double.longBitsToDouble(measurement) ));
//				}
//				System.out.print( "\n" );
			}
			/*******************************************************************************
		...
		// Write to the output file "OutputA.csv"
		BufferedWriter writer = null;
		try {
			writer = new BufferedWriter(new FileWriter("OutputA.csv"));
